...
import {NftExchangeV2} from "../src/NftExchangeV2.sol";
import {Nft} from "../src/Nft.sol";

import {IERC721} from "@openzeppelin/contracts/token/ERC721/IERC721.sol";
import {WOVER, IWOVER} from "../src/WOVER.sol";

contract NftExchangeV2Test is Test {
    WOVER WETH;
    NftExchangeV2 nftExchange;
    Nft nftA;
    Nft nftB;
    ...
    function setUp() public {
        ...
        nftExchange = new NftExchangeV2(IWOVER(address(WETH)));
        ...
        console.log("NftExchangeV2 contract size: %s", address(nftExchange).code.length);
    }
